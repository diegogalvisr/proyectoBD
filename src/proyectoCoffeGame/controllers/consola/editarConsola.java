...
public class editarConsola extends JDialog {
    private JTextField numSerie;
    private JTextField modelo;
    private JTextField precioH;
    private JTextField idCompu;

    public editarConsola(JFrame parent, int idCompuC, String numSerieC, String modeloC, int precioHC) {
    ...
    private void onAceptar(ActionEvent e) {
        ...
        if (numSeriec.isEmpty() || modeloC.isEmpty() || precioH.getText().isEmpty()) {
            ...
            editarConsola.setPrecioH(Integer.parseInt(precioHorC));
